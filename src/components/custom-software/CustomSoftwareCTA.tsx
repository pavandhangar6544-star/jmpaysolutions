...
export function CustomSoftwareCTA() {
  return (
    <section className="py-24 px-6 lg:px-8 bg-gradient-to-br from-indigo-900 via-slate-900 to-indigo-900">
      <div className="max-w-4xl mx-auto text-center">
        <div className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              className="group px-8 py-4 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-all shadow-lg flex items-center justify-center gap-2"
