...
export function BBPSCTA() {
  return (
    <section className="py-24 px-6 lg:px-8 bg-gradient-to-br from-purple-900 via-slate-900 to-purple-900">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="relative z-10 space-y-8">
          ...
          >
            Ready to Launch Your BBPS Platform?
          </h2>

          <p className="text-xl text-slate-300 max-w-2xl mx-auto">
            Enable your customers to pay all their bills in one place. Integrate
            BBPS and start processing bill payments today.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
            <button
              className="group px-8 py-4 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-all shadow-lg flex items-center justify-center gap-2"
              style={{ fontWeight: 600 }}
            >
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 pt-8 text-slate-400">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm">RBI Approved</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
              <span className="text-sm">1000+ Billers</span>
            </div>
            <div className="flex items-center gap-2">
